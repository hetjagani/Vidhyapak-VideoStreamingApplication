package cc.app.microservice.VideoProcessing.controller;

import cc.app.microservice.VideoProcessing.model.DiscoveryInfo;
import cc.app.microservice.VideoProcessing.model.DiscoveryResponse;
...
public class DiscoveryclientController {
    ...
    public void sendHeartBeat() {
        ...
        try {
            ...
            System.out.println("Connection refused by Discovery Service...");
        } catch (Exception ex) {
            System.out.println("Connection refused by Discovery Service...");
        }
